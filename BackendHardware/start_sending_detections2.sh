...
gst-launch-1.0 -e \
qtiqmmfsrc name=camsrc ! video/x-raw(memory:GBM),format=NV12,width=1280,height=720,framerate=30/1,compression=ubwc ! \
...
host="128.31.35.29" port=6379 split. ! queue ! qtimlvconverter ! queue ! qtimlsnpe delegate=dsp model=/opt/yolonas.dlc layers="</heads/Mul, /heads/Sigmoid>" ! \
